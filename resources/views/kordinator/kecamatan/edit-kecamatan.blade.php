...
<div class="page-header">
	...
	Ubah Data Kordinator Kecamatan
	</h3>
</div>
<div class="row">
	<div class="col-md-12">
...
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-body">
				<form action="{{url('kordinator/kecamatan/update/'.$data->anggota_id)}}" method="post" enctype="multipart/form-data">
					@csrf
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label>Kordinator Ring I</label>
							</div>
						</div>
					</div>
					<div class="row">
